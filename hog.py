...
def always_roll(n):
    ...
    assert n >= 0 and n <= 10
    # BEGIN PROBLEM 6
    def always_roll_n(score, op_score):
        return n
...
def is_always_roll(strategy, goal=GOAL):
    ...
    """
    # BEGIN PROBLEM 7
    if ( strategy(0,0) == always_roll(3)(0,0) or strategy == always_roll_5 ):
        return True
    else:
        return False
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    n, max_roll_score, max_roll = 1, 0, 1
    while (n<=10):
        score = make_averaged(roll_dice, total_samples)(n, dice)
        if (max_roll_score < score):
            max_roll_score = score
            max_roll = n
        n += 1
    return max_roll
    # END PROBLEM 9
